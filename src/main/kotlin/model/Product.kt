...
class Product(
    private val id: Int = 0, private val name: String? = null, private val prices: Map<User.Currency, String>? = null
) {
    ...
    constructor(doc: Document) : this(doc.getInteger(ID_FIELD),
    ...
    fun toDocument(): Document? {
        return Document(ID_FIELD, id).append(NAME_FIELD, name)
    ...
    override fun toString(): String {
        return String.format(
            ...
            User.Currency.EUR.toString(),
            prices[User.Currency.EUR],
            User.Currency.USD.toString(),
            prices[User.Currency.USD]
        )
    }
}
